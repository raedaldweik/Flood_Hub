 ...
 * dark 2D MapLibre otherwise — with an honest banner saying why (CLAUDE.md §11 feature flags).
 */
    ...
    <div className="absolute inset-0 overflow-hidden bg-bg">
      ...
      {!use3D && (
        <div className="pointer-events-none absolute inset-x-0 top-3 z-10 flex justify-center">
          <div className="glass flex items-center gap-2 px-3 py-1.5 text-[12px] text-fg-2">
